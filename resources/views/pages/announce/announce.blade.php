<div
    ...
    <div class="w-full text-center text-[#cda540] text-3xl font-bold mt-4">
       กำลังปรับปรุงเว็บไซต์
    </div>

    <div
        class=" absolute bottom-0 left-0 w-full py-1 text-[12px] font-sans text-center text-white bg-gradient-to-r from-[#E9C713] to-[#03833f]">
        � 2025 by greenglobalseeds.com
    </div>
</div>
